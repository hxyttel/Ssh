		...
		$(document).ready(function(){
			...
			$("#school").change(function(){
				...
				if(schoolId==""){
					...
					$.ajax({
						url:"/Enrollment/getMajor_country.action",
						type:"post",
						data:{"aid":schoolId},
						dataType:"json",
			...
			<div class="row clearfix"> 
				<div class="col-md-12"> 
					<div class="piece image-con" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;" data-idx="0"> 
						<div class="image-box"> 
							<a target="_blank" class="image-link" href="javascript:void(0);"> 
								<img class="image-item" src="${sessionScope.country.cyphoto1 }" /> 
							</a> 
							...
							<div class="inner"> 
								<div style="text-align: center;"> 
									<span style="line-height: 1.5; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; display: inline !important;">
										<b><font size="4" color="#ff0000">${sessionScope.country.cytitle }</font></b>&nbsp;
									</span> 
								</div> 
								<div style="text-align: center;"> 
									<font color="#000000">${sessionScope.country.cycontent }</font> 
								</div> 
							</div> 
						</div> 
					</div> 
					<div class="piece image-con" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;" data-idx="15"> 
						<div class="image-box"> 
							<a target="_blank" class="image-link" href="javascript:void(0);"> 
								<img class="image-item" src="${sessionScope.country.cyphoto2 }" /> 
							</a> 
							<span class="image-text"></span> 
						</div> 
					</div> 
					...
					<div class="piece form-piece" data-idx="18"> 
						...
						<div class="form-group"> 
							...
							<div class="form-group"> 
								<label for="schoole">报考院校</label> 
								
								<select id="school"  name="student.academyid"  class="form-control" style="width:170px;"> 
										<option value="">---请选择---</option>
										<s:iterator value="list" >
											<option value="<s:property value="aid"/>"><s:property value="aname"/>
											</option>
								     	</s:iterator>
									</select> 
							...
							<div class="form-group">
		      		  		<div class="row"> 
				           		<div class="col-xs-6">
				           			...
				           			<input class="form-control" type="text" id="kaptcha" name="kaptcha"  style="width:60%;height:32px"/>
						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<input type="text" id="scode" name="scode" class="form-control"  style="width:60%;height:32px"/>
						...
						<input type="hidden" id="stype" name="student.stype" value="国家报名" /> 
