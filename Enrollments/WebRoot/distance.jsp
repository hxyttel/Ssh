	...
	$(document).ready(function(){
		...
		$('#school').change(function(){
			...
			if(schoolId==""){
				...
				$.ajax({
					url:"/Enrollment/getMajor_distance.action",
					type:"post",
					data:{"aid":schoolId},
					dataType:"json",
		...
		$("form").bind("submit",function(){
			if($("#s_rightName").is(":hidden")||$("#s_rightCode").is(":hidden")||$("#s_rightphone").is(":hidden")||$('#s_rightmsg').is(":hidden")||$('#s_rightContent').is(":hidden")||$('#s_rightIdcard').is(":hidden")||$('#s_rightAcontent').is(":hidden")||$('#s_rightSchool').is(":hidden")||$('#s_rightSgradations').is(":hidden")){
			...
			<div class="row clearfix"> 
				<div class="col-md-12"> 
					<div class="piece image-con" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;" data-idx="0"> 
						<div class="image-box"> 
							<a target="_blank" class="image-link" href="javascript:void(0);"> 
								<img class="image-item" src="${sessionScope.distance.dephoto1 }" /> 
							</a> 
							...
							<div class="inner"> 
								<div style="text-align: center;"> 
									<span style="line-height: 1.5; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; display: inline !important;">
										<b><font size="4" color="#ff0000">${sessionScope.distance.detitle }</font></b>&nbsp;
									</span> 
								</div> 
								<div style="text-align: center;"> 
									<font color="#000000">${sessionScope.distance.decontent }</font> 
								</div> 
							</div> 
						</div> 
					</div>
					<div class="piece image-con" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;" data-idx="10"> 
						<div class="image-box"> 
							<a target="_blank" class="image-link" href="javascript:void(0);"> 
								<img class="image-item" src="${sessionScope.distance.dephoto2 }" /> 
							</a> 
							<span class="image-text"></span> 
						</div> 
					</div>   
					<div class="piece image-con" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;" data-idx="10"> 
						<div class="image-box"> 
							<a target="_blank" class="image-link" href="javascript:void(0);"> 
								<img class="image-item" src="img/adu_dis_cou/dis3_0.png" /> 
							</a> 
							<span class="image-text"></span> 
						</div> 
					</div>
					...
					<div class="piece form-piece" data-idx="18"> 
						...
						<div class="form-group"> 
							...
							<div class="form-group"> 
								...
								<input type="text" onblur="abc()" class="form-control" id="idcard" name="student.snumber" style="width:60%;height:32px" /> 
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									...
									<select id="sgradations" name="student.sgradations" onclick="selected();" class="form-control" style="width:170px;">  
										<option value="">---请选择---</option>
							...
							<div class="form-group">
		      		  		<div class="row"> 
				           		<div class="col-xs-6">
				           			...
				           			<input class="form-control" type="text" onblur="yzm()" id="kaptcha" name="kaptcha"/>
				        	...
				        	<input type="text" class="form-control" id="sphone" onblur="phone()" name="student.sphone" style="width:60%;height:32px"/>
						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<input type="text" id="scode" name="scode" onblur="dxsjh()" class="form-control"/>
						...
						<input type="hidden" id="stype" name="student.stype" value="远程报名" /> 
